  ...
  return (
    <section className="container text-r-text py-9">
      ...
      <div className="inline-block">
        <div data-subtitle className="w-[110%] whitespace-nowrap overflow-hidden font-heading2 font-bold mb-6 text-r-accent-80 animate [&.animate]:animate-[typing_.5s_steps(28)]">
          {
